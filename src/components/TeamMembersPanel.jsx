...
async function sendNotification(userId, type, title, body) {
  ...
  if (prefs && prefs[`email_${type}`] === true) {
    ...
    if (recipientEmail) {
      ...
      const htmlBody = buildEmailHtml({ title, body, ctaLabel: 'View Invite in iLab →', ctaUrl: 'https://mtt999.github.io/ilab/?screen=profile&tab=team', prefsUrl: 'https://mtt999.github.io/ilab/?screen=profile', orgContact })
