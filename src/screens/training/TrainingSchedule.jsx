...
async function sendTrainingEmail(userId, prefKey, subject, title, body) {
  ...
  const htmlBody = buildEmailHtml({ title, body, ctaLabel: 'View Training in iLab →', ctaUrl: 'https://mtt999.github.io/ilab/', prefsUrl: 'https://mtt999.github.io/ilab/', orgContact })
